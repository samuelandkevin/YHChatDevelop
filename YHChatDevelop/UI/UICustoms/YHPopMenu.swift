...
//
//  Created by samuelandkevin on 2017/5/11.
    ...
    var  dictConfig: Dictionary<String,Any>?  = nil {
        willSet (newValue){
            if let newV = newValue {
                ...
                var itemBgColor = kBlueColor_Swift
...
class YHPopMenu : UIView,UITableViewDelegate,UITableViewDataSource{
    ...
    func _setup(){
        ...
        _tableView.register(CellForMenuItem.classForCoder(), forCellReuseIdentifier: CellForMenuItem.className())
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        guard let cell = tableView.dequeueReusableCell(withIdentifier: CellForMenuItem.className()) as? CellForMenuItem else{
