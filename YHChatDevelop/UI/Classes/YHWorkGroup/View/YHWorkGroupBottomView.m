...
@interface YHWorkGroupBottomView()
...
@implementation YHWorkGroupBottomView
...
//    sender.selected = !sender.selected;
    if (_delegate && [_delegate respondsToSelector:@selector(onLikeInView:)]) {
        [_delegate onLikeInView:self];
    }
}
