...
- (void)retweetMsg:(YHChatModel *)msg inRightCell:(CellChatTextRight *)rightCell;//转发消息
- (void)withDrawMsg:(YHChatModel *)msg inRightCell:(CellChatTextRight *)rightCell;//撤回消息
