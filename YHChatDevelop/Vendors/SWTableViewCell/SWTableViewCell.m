...
//samuelandkevin add Method
- (void)setContentOffest:(CGPoint)contentOffset animated:(BOOL)animated{
    [_cellScrollView setContentOffset:contentOffset animated:animated];
}
