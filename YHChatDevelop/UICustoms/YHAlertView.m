...
typedef void (^YHAlertViewClickButtonBlock) (YHAlertView *alertView,NSUInteger buttonIndex);
...
@property(nonatomic, copy)YHAlertViewClickButtonBlock clickButtonBlock;
...
+ (void)showWithTitle:(nullable NSString *)title message:(nullable NSString *)message cancelButtonTitle:(nullable NSString *)cancelButtonTitle otherButtonTitle:(nullable NSString *)otherButtonTitle clickButtonBlock:(nonnull void (^)(YHAlertView * _Nonnull, NSUInteger))block{
    YHAlertView *alertView = [[YHAlertView alloc]initWithTitle:title message:message delegate:nil cancelButtonTitle:cancelButtonTitle otherButtonTitles:otherButtonTitle, nil];
...
- (void)setupDefault
{
    ...
    self.visual = YES;
    self.animationOption = YHAlertAnimationOptionZoom;
...
- (void)show {
    ...
    switch (self.animationOption) {
        case YHAlertAnimationOptionNone:{
            ...
            break;
        case YHAlertAnimationOptionZoom:{
            ...
            break;
        case YHAlertAnimationOptionTopToCenter:{
